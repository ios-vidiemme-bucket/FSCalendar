...
- (void)configureAppearance
{
    ...
    NSArray *weekdaySymbols = useVeryShortWeekdaySymbols ? self.calendar.calendarWrapper.veryShortStandaloneWeekdaySymbols : self.calendar.calendarWrapper.shortStandaloneWeekdaySymbols;
